...
const StaticMap = () => {
  ...
  const lat = yextDisplayCoordinate.latitude;
  const long = yextDisplayCoordinate.longitude;

  const defaultProps = {
    center: {
      lat: yextDisplayCoordinate.latitude,
      lng: yextDisplayCoordinate.longitude
    },
    zoom: 15
  };
    ...
    <>
      <div className="mt-20 space-y-6">
        {/* <div className="flex space-x-2 items-center">
          <MapPin size={30} />
          <h2 className="tracking">Come Visit Us</h2>
        </div> */}
